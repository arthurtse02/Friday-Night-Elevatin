...
class PlayState extends MusicBeatSubState
{
  ...
  **/
  ...
  function initHealthBar():Void
  {
    ...
    scoreText = new FlxText(healthBarBG.x - healthBarBG.width / 2, healthBarBG.y + 26, 0, "", 20);
    scoreText.setFormat(Paths.font('fullphanmuff.ttf'), 20, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
    scoreText.y = healthBarBG.y - 18;
    scoreText.scrollFactor.set();
    scoreText.zIndex = 802;
    add(scoreText);

    missTxt = new FlxText(scoreText.x, scoreText.y - 26, 0, "", 20);
    missTxt.setFormat(Paths.font('fullphanmuff.ttf'), 20, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
    missTxt.y = scoreText.y + 26;
  ...
  function updateScoreText():Void
  {
    ...
    else
    {
      ...
      missTxt.text = 'Missed: ' + songMisses;
  ...
  public function endSong(rightGoddamnNow:Bool = false):Void
  {
    ...
    if (PlayStatePlaylist.isStoryMode)
    {
      ...
      PlayStatePlaylist.campaignMisses += songMisses;
